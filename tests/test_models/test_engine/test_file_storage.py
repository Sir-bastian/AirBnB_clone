...
class test_storage(unittest.TestCase):
    ...
    """ 
    A class for testing the file storage method 
    """
    ...
    def test_no_objs(self):
        """ 
        Inspecting an empty class. 
        """
        self.assertEqual(storage.all(), {})

    def test_all(self):
        """ 
        Evaluating the 'check_all' function. 
        """
        storage = FileStorage()
        obj = storage.all()
